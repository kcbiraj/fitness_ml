...
y_test.value_counts().plot(kind="bar", ax=ax, color="blue", label="Test")
plt.legend()
plt.show()
...
squared_features = ["acc_r", "gyro_r"]
pca_features = ["pca_1", "pca_2", "pca_3"]
time_features = [f for f in df_train.columns if "_temp_" in f]
freq_features = [f for f in df_train.columns if ("freq" in f) or ("_pse_" in f)]
...
plt.show()
print("Selected features: ", ordered_features)
